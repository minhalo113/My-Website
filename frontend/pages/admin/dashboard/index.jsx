...
const AdminDashboard = () => {
    ...
    const [totalSale, totalOrder, totalProduct, totalSeller] = Array(4).fill(0)
    const recentMessage = []
    const recentOrder = []
    ...
    return(
        <div className="px-2 md:px-7 py-5">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7">
                <div className="flex justify-between items-center p-5 bg-[#fae828] rounded-md gap-3">
                ...
                <div className="flex justify-between items-center p-5 bg-[#fde2ff] rounded-md gap-3">
                    ...
                    <div className="w-[40px] h-[47px] rounded-full bg-[#760077] flex justify-center items-center text-xl">
                        <MdCurrencyExchange className='text-[#fae8e8] shadow-log'/>
                    </div>
                </div>
                ...
                <div className="flex justify-between items-center p-5 bg-[#e9feea] rounded-md gap-3">
                    ...
                    <div className="w-[40px] h-[47px] rounded-full bg-[#038000] flex justify-center items-center text-xl">
                        <FaUsers className = 'text-[#fae8e8] shadow-log'/>
                    </div>
                </div>
                            ...
                            <ol className="relative border-1 border-slate-600 ml-4">
                                {
                                    (recentMessage || []).map((m, i) => <li key = {i} className="mb-3 ml-6">
                                        <div className="flex absolute -left-5 shadow-lg justify-center items-center w-10 h-10 p-[6x] bg-[#4c7fe2] rounded-full z-10">
                                            {
                                                m.senderId === userInfo._id ? <img className="w-full rounded-full h-full shadow-lg" src = {userInfo.image} alt = ""/> : <img className="w-full rounded-full h-full shadow-lg" alt = ""/>
                                            }
                                        </div>
            ...
            <div className="w-full p-4 bg-[#6a5fdf] rounded-md mt-6">
                ...
                <div className="relative overflow-x-auto">
                    <table className="w-full text-sm text-left text-[#d0d2d6]">
                        <thread className = 'text-sm text-[#d0d2d6] uppercase border-b border-slate-700'>
                            <tr>
                        ...
                        <tbody>
                            {
                                recentOrder.map((d, i) => <tr key = {i}>
                                    ...
                                    {/* <Link href={`/admin/dashboard/order/details/${d._id}`}>View</Link> */}
                                        <span>View</span>
                                    </td>
                                </tr>)
                            }
