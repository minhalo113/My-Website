                ...
                <div className='product-thumb'>
                  <div className='pro-thumb relative' style={{ width: '100%', aspectRatio: '1/1' }}>
                    ...
                    {product.productType !== 'affiliate' && (
                      <span className="absolute bottom-2 left-2 bg-slate-800 text-white text-xs font-bold px-2 py-1 rounded shadow-md z-10 opacity-90 flex items-center justify-center">
                        {shippingFlag}
                      </span>
                    )}
                    {product.productType === 'affiliate' ? (
