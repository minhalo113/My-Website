            ...
            await sendMail({
                ...
                html: `
                    <div style="font-family: sans-serif; line-height: 1.5; color: #333;">
                        ...
                        <p>We have placed a <strong>temporary authorization hold</strong> on your card for <strong>CAD $${(Number(sess.amount_total) / 100).toFixed(2)}</strong>.</p>
                ...
                `,
                text: `Hi there,\n\nThanks for shopping with A Figure A Day! We have received your order request.\n\nWhat happens next?\nWe have placed a temporary authorization hold on your card for CAD $${(Number(sess.amount_total) / 100).toFixed(2)}. We will not capture the payment until we verify that your items are in stock and ready for preparation.\n\nOrder reference: ${orderId}\n\nNeed help? Please email us at figureaday.store@gmail.com. (Please do not reply to this automated email).`
            });
